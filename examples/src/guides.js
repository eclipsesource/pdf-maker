...
const def = {
  ...
  dev: { guides: true },
  fonts: { 'DejaVu-Sans': [{ data: fontData }, { data: fontDataBold, bold: true }] },
  defaultStyle: {
    fontSize: 12,
  },
  margin: { x: '20mm', top: '10mm', bottom: '5mm' },
  header: {
    columns: [{ text: 'PDF Maker' }, { text: 'Guides', textAlign: 'right', width: 'auto' }],
  ...
  content: [
    ...
    {
      text: [
        'This block has "breakBefore" set to "avoid", indicated by a gray dot at the top left.',
      ],
      breakBefore: 'avoid',
      margin: { y: 5 },
    },
