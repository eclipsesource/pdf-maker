      ...
      columns: [
        {
          graphics: [
            ...
            { type: 'line', x1: 10, y1: 20, x2: 80, y2: 20, strokeColor: 'green' },
            { type: 'line', x1: 10, y1: 30, x2: 80, y2: 30, strokeWidth: 7 },
            { type: 'rect', x: 120, y: 10, width: 20, height: 20 },
            { type: 'rect', x: 130, y: 20, width: 20, height: 20, fillColor: '#cccccc' },
            {
              type: 'rect',
              x: 140,
              y: 30,
